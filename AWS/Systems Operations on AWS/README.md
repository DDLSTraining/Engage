...
* [“Routing traffic to an ELB load balancer” in the Amazon Route 53 Developer Guide :]( https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/routing-to-elb-load-balancer.html)
...
* [“Why is my CloudWatch alarm in INSUFFICIENT_DATA state?” in the AWS Knowledge Center : ](https://aws.amazon.com/premiumsupport/knowledge-center/cloudwatch-alarm-insufficient-data-state/)
...
* [VPC and subnets limits :]( https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/amazon-vpc-limits.html#vpc-limits-vpcs-subnets(opens in a new tab)
* [“Network ACL rules” in the Amazon VPC User Guide :]( https://docs.aws.amazon.com/vpc/latest/userguide/vpc-network-acls.html#nacl-rules(opens in a new tab)
* [“Security groups” in the Amazon VPC User Guide :]( https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/amazon-vpc-limits.html#vpc-limits-security-groups(opens in a new tab)
* [“Security” in the Amazon VPC User Guide :]( https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Scenario3.html#VPC_Scenario3_Security(opens in a new tab)
* [“Security group rules for different use cases” in the Amazon EC2 User Guide for Linux Instances : ](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/security-group-rules-reference.html(opens in a new tab)
* [“What is VPC peering” in the Amazon VPC User Guide :]( https://aws.amazon.com/about-aws/whats-new/2017/11/announcing-support-for-inter-region-vpc-peering/(opens in a new tab)
* [“What is AWS Site-to-Site VPN?” in the AWS VPN User Guide : ](http://docs.aws.amazon.com/AmazonVPC/latest/NetworkAdminGuide/Welcome.html(opens in a new tab)
* [“AWS Transit Gateway” on AWS :]( https://aws.amazon.com/transit-gateway/(opens in a new tab)
* [“VPC endpoints” in the Amazon VPC User Guide :]( https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/vpc-endpoints.html(opens in a new tab)
* [“Resolving DNS queries between VPCs and your network” in the Amazon Route 53 Developer Guide :]( https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/resolver.html(opens in a new tab)
* [“VPC Flow Logs” in the Amazon VPC User Guide :]( https://docs.aws.amazon.com/vpc/latest/userguide/flow-logs.html(opens in a new tab)
* [“What is Amazon CloudFront?” in the Amazon CloudFront Developer Guide : ](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Introduction.html(opens in a new tab)
* [“How CloudFront delivers content” in the Amazon CloudFront Developer Guide :]( https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/HowCloudFrontWorks.html(opens in a new tab)
* [“Origin Settings” in the Amazon CloudFront Developer Guide :]( https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesOrigin(opens in a new tab)
* [“Distribution Settings” in the Amazon CloudFront Developer Guide :]( https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesGeneral(opens in a new tab)
* [“Cache Behavior Settings” in the Amazon CloudFront Developer Guide :]( https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesCacheBehavior(opens in a new tab)
* [“Managing how long content stays in the cache (expiration)” : ](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Expiration.html(opens in a new tab)
* [“AWS Managed Rules rule groups list” in the AWS WAF Developer Guide : ](https://docs.aws.amazon.com/waf/latest/developerguide/aws-managed-rule-groups-list.html(opens in a new tab)
* [" AWS WAF rules" : ](https://docs.aws.amazon.com/waf/latest/developerguide/waf-rules.html(opens in a new tab)
* [“Planning Your ACM Private CA Deployment” in the AWS Private Certificate Authority User Guide : ](https://docs.aws.amazon.com/acm-pca/latest/userguide/PcaPlanning.html(opens in a new tab)
* ["Resilience in Amazon Virtual Private Cloud" : ](https://docs.aws.amazon.com/vpc/latest/userguide/disaster-recovery-resiliency.html(opens in a new tab)
* ["Global Infrastructure" :]( https://aws.amazon.com/about-aws/global-infrastructure/(opens in a new tab)
...
* [“Amazon EC2 instance store” in the Amazon EC2 User Guide for Linux Instances : ](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/InstanceStorage.html(opens in a new tab)
* [“Storage-optimized instances” in the Amazon EC2 User Guide for Linux Instances :]( https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/storage-optimized-instances.html(opens in a new tab)
* [“What's the difference between instance store and EBS?” on AWS Knowledge Center : ](https://aws.amazon.com/premiumsupport/knowledge-center/instance-store-vs-ebs/(opens in a new tab)
* [“Amazon EBS volume types" in the Amazon EC User Guide for Linux Instances : ](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html(opens in a new tab)
* [“General Purpose SSD volumes (gp2)” in the Amazon EC2 User Guide for Linux Instances : ](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-volume-types.html#EBSVolumeTypes_gp2(opens in a new tab)
* [“Hard disk drives (HDD)” in the Amazon EC2 User Guide for Linux Instances :]( https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-volume-types.html#hard-disk-drives(opens in a new tab)
* [“Create an Amazon EBS volume” in the Amazon EC2 User Guide for Linux Instances :]( https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-creating-volume.html(opens in a new tab)
* [“Make an Amazon EBS volume available for use on Linux” in the Amazon EC2 User Guide for Linux Instances : ](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-using-volumes.html(opens in a new tab)
* [“Request modifications to your EBS volumes” :]( https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/requesting-ebs-volume-modifications.html(opens in a new tab)
* ["Requirements when modifying volumes" :]( https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/modify-volume-requirements.html(opens in a new tab)
* [Extend a Linux file system after resizing a volume” :]( https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/recognize-expanded-volume-linux.html(opens in a new tab)
* ["Amazon Elastic Block Store endpoints and quotas" :]( https://docs.aws.amazon.com/general/latest/gr/ebs-service.html(opens in a new tab)
* [“RAID configuration on Linux” in the Amazon EC2 User Guide for Linux Instances : ](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/raid-config.html(opens in a new tab)
* [“RAID configuration on Windows” in the Amazon EC2 User Guide for Windows Instances : ](https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/raid-config.html(opens in a new tab)
* [“Attach a volume to multiple instances with Amazon EBS Multi-Attach” : vhttps://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-volumes-multi.html(opens in a new tab)
* [“Considerations and limitations” :]( https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-volumes-multi.html#considerations(opens in a new tab)
* [“EBS volume status checks” in the Amazon EC2 User Guide for Linux Instances : ](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/monitoring-volume-status.html#monitoring-volume-checks(opens in a new tab)
* [“Amazon CloudWatch metrics for Amazon EBS” in the Amazon EC2 User Guide for Linux Instances :]( https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using_cloudwatch_ebs.html(opens in a new tab)
* [“Copy an Amazon EBS snapshot” in the Amazon EC2 User Guide for Linux Instances :]( https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-copy-snapshot.html(opens in a new tab)
* [“Create a VSS application-consistent snapshot” in the Amazon EC2 User Guide for Windows Instances :]( https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/application-consistent-snapshots.html(opens in a new tab)
* [“Amazon EBS fast snapshot restore” :]( https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-fast-snapshot-restore.html(opens in a new tab)
* [“Create a volume from a snapshot” : ](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-creating-volume.html#ebs-create-volume-from-snapshot(opens in a new tab)
* [“Amazon Data Lifecycle Manager” in the Amazon EC2 User Guide for Linux Instances :]( https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/snapshot-lifecycle.html(opens in a new tab)
* [“Creating a Backup Plan” in the AWS Backup Developer Guide : ](https://docs.aws.amazon.com/aws-backup/latest/devguide/creating-a-backup-plan.html(opens in a new tab)
* [“NFS Support” :]( https://docs.aws.amazon.com/efs/latest/ug/mounting-fs-old.html#mounting-fs-nfs-info(opens in a new tab)
* [“Installing the NFS Client” :]( https://docs.aws.amazon.com/efs/latest/ug/mounting-fs-old.html#mounting-fs-install-nfsclient(opens in a new tab)
* ["Amazon EFS performance" : ](https://docs.aws.amazon.com/efs/latest/ug/performance.html(opens in a new tab)
* [“Using Microsoft Windows File Shares” in the Amazon FSx Windows User Guide : ](https://docs.aws.amazon.com/fsx/latest/WindowsGuide/using-file-shares.html(opens in a new tab)
* [“Mounting from an Amazon EC2 Instance” in the Amazon FSx Lustre User Guide : ](https://docs.aws.amazon.com/fsx/latest/LustreGuide/mounting-ec2-instance.html(opens in a new tab)


### Module 13

* [“When to use Cross-Region Replication” in the Amazon S3 Developer Guide :]( https://docs.aws.amazon.com/AmazonS3/latest/dev/replication.html#crr-scenario(opens in a new tab)
* [Using Amazon S3 block public access” in the Amazon Simple Storage Service Developer Guide :]( https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html(opens in a new tab)
* [“Using Access Analyzer for S3” in the Amazon Simple Storage Service Console User Guide :]( https://docs.aws.amazon.com/AmazonS3/latest/user-guide/access-analyzer.html(opens in a new tab)
* [“Amazon S3 Server Access Log Format” in the Amazon Simple Storage Service Developer Guide : ](https://docs.aws.amazon.com/AmazonS3/latest/dev/LogFormat.html(opens in a new tab)
* [“Configuring Amazon S3 event notifications” in the Amazon Simple Storage Service Developer Guide :]( https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html(opens in a new tab)
* [“Amazon S3 storage classes” in the Amazon Simple Storage Service Developer Guide :]( https://aws.amazon.com/s3/storage-classes/(opens in a new tab)
* [“Performance across the S3 Storage Classes” on the AWS website :]( https://aws.amazon.com/s3/storage-classes/#Performance_across_the_S3_Storage_Classes(opens in a new tab)
* [“Transitioning objects using Amazon S3 Lifecycle” in the Amazon Simple Storage Service Developer Guide :]( https://docs.aws.amazon.com/AmazonS3/latest/dev/lifecycle-transition-general-considerations.html(opens in a new tab)
* [“How do I create a lifecycle rule for an S3 bucket?” in the Amazon Simple Storage Service Console User Guide :]( https://docs.aws.amazon.com/AmazonS3/latest/user-guide/create-lifecycle.html(opens in a new tab)
* ["What Is Amazon S3 Glacier?” in the Amazon S3 Glacier Developer Guide : ](http://docs.aws.amazon.com/amazonglacier/latest/dev/introduction.html(opens in a new tab)
* [“Retrieving S3 Glacier Archives” in the Amazon S3 Glacier Developer Guide : ](https://docs.aws.amazon.com/amazonglacier/latest/dev/downloading-an-archive-two-steps.html(opens in a new tab)
* ["Working with Vaults in Amazon S3 Glacier" :]( https://docs.aws.amazon.com/amazonglacier/latest/dev/working-with-vaults.html(opens in a new tab)

### Module 14

* ["Cost Optimization Pillar - AWS Well-Architected Framework" :]( https://docs.aws.amazon.com/wellarchitected/latest/cost-optimization-pillar/welcome.html(opens in a new tab)
* ["Laying the Foundation: Setting Up Your Environment for Cost Optimization" : ](https://docs.aws.amazon.com/whitepapers/latest/cost-optimization-laying-the-foundation/introduction.html(opens in a new tab)
* [“Viewing your bill” in the AWS Billing and Cost Management User Guide : ](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/getting-viewing-bill.html(opens in a new tab)
* [“Analyzing your costs with Cost Explorer” in the AWS Billing and Cost Management User Guide :]( https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/ce-what-is.html(opens in a new tab)
* [“Modifying your chart” in the AWS Billing and Cost Management User Guide :]( https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/ce-modify.html(opens in a new tab)
* [“Forecasting with Cost Explorer” in the AWS Billing and Cost Management User Guide :]( https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/ce-forecast.html(opens in a new tab)
* [“Creating Cost and Usage Reports” :]( https://docs.aws.amazon.com/cur/latest/userguide/creating-cur.html(opens in a new tab)
* [“Querying Cost and Usage Reports using Amazon Athena” : ](https://docs.aws.amazon.com/cur/latest/userguide/cur-query-athena.html(opens in a new tab)
* [“Level 300: Automated Athena CUR Query and E-mail Delivery” on the AWS Well-Architected Labs, Cost Optimization website :]( https://wellarchitectedlabs.com/cost/300_labs/300_automated_cur_query_and_email_delivery(opens in a new tab)
* [“Creating a cost budget” : ](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/budgets-create.html#create-cost-budget(opens in a new tab)
* [“Creating a reservation budget” :]( https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/budgets-create.html#create-reservation-budget(opens in a new tab)
* [“Creating a Savings Plans budget” :]( https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/budgets-create.html#create-savingsplans-budget(opens in a new tab)
* [“Available budget filters” in the AWS Billing and Cost Management User Guide :]( https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/budgets-create-filters.html(opens in a new tab)
* [“Receiving budget alerts in Amazon Chime and Slack” in the AWS Billing and Cost Management User Guide :]( https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/sns-alert-chime.html(opens in a new tab)
* [“Creating a Billing Alarm to Monitor Your Estimated AWS Charges” in the Amazon CloudWatch User Guide :]( https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/monitor_estimated_charges_with_cloudwatch.html(opens in a new tab)
* [“Optimizing your cost with Rightsizing Recommendations” in the AWS Billing and Cost Management User Guide : https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/ce-rightsizing.html(opens in a new tab)
* [“Understanding your Savings Plans recommendations” in the Savings Plan User Guide :]( https://docs.aws.amazon.com/savingsplans/latest/userguide/sp-recommendations.html(opens in a new tab)
* [“Accessing Reserved Instance Recommendations” in the AWS Billing and Cost Management User Guide :]( https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/ri-recommendations.html(opens in a new tab)
* [“AWS Trusted Advisor best practice checklist” on the AWS website :]( https://aws.amazon.com/premiumsupport/technology/trusted-advisor/best-practice-checklist/(opens in a new tab)
v“AWS Compute Optimizer” on the AWS website : ](https://docs.aws.amazon.com/compute-optimizer/latest/ug/what-is-compute-optimizer.html(opens in a new tab)
* [“Viewing the AWS Compute Optimizer dashboard” in the AWS Compute Optimizer User Guide :]( https://docs.aws.amazon.com/compute-optimizer/latest/ug/viewing-dashboard.html(opens in a new tab)
* [“Optimizing your cost with Rightsizing Recommendations” in the AWS Billing and Cost Management User Guide :]( https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/ce-rightsizing.html(opens in a new tab)
* [“It just got easier to discover and compare EC2 instance types” in the AWS Compute Blog :]( https://aws.amazon.com/blogs/compute/it-just-got-easier-to-discover-and-compare-ec2-instance-types/(opens in a new tab)

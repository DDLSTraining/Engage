...
```powershell
scoop install azure-cli azure-ps azure-functions-core-tools vscode docker docker-compose nodejs coreutils sed grep nmap jq openssh git vim wget kubectl helm terraform
```
